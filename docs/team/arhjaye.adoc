...
My main contributions to NoteNote is the implementation of 2 of my features, `taskhistory` and `compare`.
I have also contributed to the team by helping manage version releases and ensuring deliverables are met.
...
* *Code contributed*: [https://nuscs2113-ay1819s2.github.io/dashboard-beta/#search=arhjaye[Functional code]]
